...
public class RangedAngerPickup : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (!handler) { Debug.LogWarning("[RangedAngerPickup] UpgradeHandler not found."); return; }
        ...
        Debug.Log("Picked up Ranged Anger!");
